    ...
    if (typeof define === 'function' && define.amd) {
        ...
        var TableExport = function (selectors, options, isUpdate) {
            ...
            self.selectors.each(function () {
                    ...
                    exporters = {
                        xlsx: function (rDel, name) {
                            var rcMap = {},
                                ...
                                myContent = "<img src='assets/exportJS/xlsx.svg' class='mx-auto d-block'>",
                                myClass = TableExport.prototype.xlsx.defaultClass;
                            createObjButton(dataObject, myContent, myClass,"xlsx");
                        },
                        xlsm: function (rDel, name) {
                            var rcMap = {},
                                ...
                                myContent = "<img src='assets/exportJS/xls.svg' class='mx-auto d-block'>",
                                myClass = TableExport.prototype.xls.defaultClass;
                            createObjButton(dataObject, myContent, myClass,"xls");
                        },
                        ...
                        csv: function (rdel, name) {
                            var colD = TableExport.prototype.csv.separator,
                                ...
                                myContent = "<img src='assets/exportJS/csv.svg' class='mx-auto d-block'>",
                                myClass = TableExport.prototype.csv.defaultClass;
                            createObjButton(dataObject, myContent, myClass,"csv");
                        },
                        txt: function (rdel, name) {
                            var colD = TableExport.prototype.txt.separator,
                                ...
                                myContent = "<img src='assets/exportJS/txt.svg' class='mx-auto d-block'>",
                                myClass = TableExport.prototype.txt.defaultClass;
                            createObjButton(dataObject, myContent, myClass,"txt");
                        }
                    };
                 ...
                 */
                function checkCaption(exportButton, type) {
                    var $caption = $el.find('caption:not(.head)');
                    $caption.length ? $caption.append(exportButton) : $el.prepend('<div class="' + bootstrapSpacing + self.settings.position +' '+type+' download-button-wrapper">' + exportButton + '</div>');
                }
                 ...
                 */
                function createObjButton(dataObject, myContent, myClass, type) {
                    var exportButton = "<button data-fileblob='" + dataObject + "' class='" + bootstrapClass + bootstrapTheme + myClass + " download-button' title='Download as " +type + "'>" + myContent + "</button>";
                    checkCaption(exportButton, type);
                }
            });
        ...
        TableExport.prototype = {
            ...
            remove: function () {
                this.selectors.each(function () {
                    $(this).find('.download-button-wrapper').remove();
                });
            }
        };
